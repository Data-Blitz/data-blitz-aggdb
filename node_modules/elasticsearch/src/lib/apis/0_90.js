 ...
 * @param {Boolean} params.collections - A comma-separated list of search collections for `search` statistics
 ...
 * @param {Boolean} params.search - Return information about search operations; use the `collections` parameter to include information for specific search collections
 ...
 * @param {String, String[], Boolean} params.searchGroups - A comma-separated list of search collections to include in the `search` statistics
 */
